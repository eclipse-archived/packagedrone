...
public interface FormBasedConfigurationController<T>
{
    @RequestMapping ( method = RequestMethod.POST )
    public default ModelAndView updateFrom ( @RequestParameter ( "channelId" ) final String channelId, @RequestParameter ( "triggerId" ) final String triggerId, @RequestParameter (
            value = "processorId",
